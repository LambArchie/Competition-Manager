...
Revision ID: 0bf9e306bc2c
Revises: 
Create Date: 2019-05-03 11:25:21.533906
...
def upgrade():
    ...
    op.create_table('category_review_assoc',
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('category_review_assoc')
